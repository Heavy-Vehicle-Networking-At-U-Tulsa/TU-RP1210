...
# setup.py was inspired by https://github.com/pypa/sampleproject
...
setup(
    ...
    description='A PyQt5 GUI framework for heavy vehicle diagnostic adapters using RP1210',  # Required
    ...
    url='https://github.com/Heavy-Vehicle-Networking-At-U-Tulsa/TU-RP1210',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='The Universtity of Tulsa, Mechanical Engineering',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='jeremy-daily@utulsa.edu',  # Optional
    ...
    keywords='CAN RP1210 heavy vehicle diagnositics',  # Optional
