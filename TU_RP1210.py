...
class TU_RP1210(QMainWindow):
    ...
    def init_ui(self):
        ...
        export_to_pdf = QAction(QIcon(r'icons/icons8_PDF_48px.png'), 'Export to &PDF', self)
        ...
        export_to_json = QAction(QIcon(r'icons/icons8_CSV_48px.png'), 'Expor&t to JSON', self)
        ...
        sign_file_action = QAction(QIcon(r'icons/icons8_Hand_With_Pen_48px.png'), 'Si&gn File', self)
        ...
        verify_file_action = QAction(QIcon(r'icons/icons8_Approval_48px_1.png'), '&Verify File', self)
        ...
        run_action = QAction(QIcon(r'icons/icons8_Go_48px.png'), 'Get All &Known Data', self)
        ...
        graph_data_action = QAction(QIcon(r'icons/icons8_Line_Chart_48px.png'), '&Plot Incident Graphs', self)
        ...
        register = QAction(QIcon(r'icons/icons8_Registration_48px.png'), '&Enter User Information', self)
        ...
        #Add some labels and content
        self.gps_icon = QLabel("<html><img src='icons/icons8_GPS_Disconnected_48px.png'><br>Disconnected</html>")
    ...
    def check_connections(self):
        ...
        for key in ["J1939", "J1708"]:            
            ...
            if count_change > 0 and not self.network_connected[key]: 
                ...
                self.status_icon[key].setText("<html><img src='icons/icons8_Unavailable_48px.png'><br>Network<br>Unavailable</html>")
    ...
    def setup_gps(self, dialog=True):
        ...
        if self.GPS.connected:
            self.gps_icon.setText("<html><img src='icons/icons8_GPS_Signal_48px.png'><br>Connected on {}</html>".format(self.GPS.ser.port))
            ...
            self.gps_icon.setText("<html><img src='icons/icons8_GPS_Disconnected_48px.png'><br>Disconnected</html>")
