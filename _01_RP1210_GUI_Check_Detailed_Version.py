...
class RP1210(tk.Frame):
    ...
    def init_gui(self):
        ...
        detailed_version_button.grid(row=0,column=0,padx=10,pady=10)
        
        
    def display_detailed_version(self):
        """Brings up a dialog box that shows the detailed version of the RP1210 device and driver"""
...
#Assignment:
#Create a new button that can read the RP1210 Version information from the driver and display it in an info box.
#This is less than the detailed version.
#You'll need to reference the RP1210 document to be sure how to read the data.
